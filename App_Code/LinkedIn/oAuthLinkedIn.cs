...
public class oAuthLinkedIn : oAuthBase2
{
    ...
    public string ConsumerKey
    {
        get
        {
            ...
            {
               // _consumerKey = "70g7x04p4r0b"; // ConfigurationManager.AppSettings["LiApiKey"]; //"70g7x04p4r0b"
            }
            return _consumerKey;
        }
    ...
    public string ConsumerSecret
    {
        get
        {
            ...
            {
                // _consumerSecret = "phnCQc8wtjYIaQ6J"; //ConfigurationManager.AppSettings["LiSecretKey"]; //"phnCQc8wtjYIaQ6J"; 
            }
